...
Description:  Demonstrates how to use ADT7420 temperature sensor with the EV-COG-AD3029LZ.
...
Hardware Setup:
===============
    Connect the ADT7420 temperature sensor shield to the I2C PMOD connector on the EV-COG-AD3029LZ board. PMOD connectors are on the opposite end of the board from the power connector. The underside of the board labels which of the two PMOD connectors is for I2C.

    In release mode the data will be printed to the host terminal. The UART redirection setup on the EV-COG-AD3029LZ is detailed below:
...
=====================
    ...
    For a release build the output will be redirected to the host terminal via the UART. Click on "EV-COG-AD3029LZ_Release.launch" and 
    ...
    If ADI_APP_USE_BLUETOOTH is set to 1u, follow the instructions below: 
        ...
        4. Click on "ADT7420 Demo" once it becomes available on the list of devices. This will create a connection to the EV-COG-AD3029LZ board.
